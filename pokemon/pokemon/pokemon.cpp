...
pokemon::pokemon(QString name, int _level, Poke_quality _style, Quality _power, Quality _hp, Quality _defense, Quality _agile)
{
    the_name=name;
    level=_level;
    exp=0;
...
void pokemon::toAttack(QString &SkillName, int &hurt)
{
    SkillName="null";
    hurt=0;
}
